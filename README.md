...
- App.js
  ...
  - copy/paste all the content within body tags, up to 'script' tag (index.html)
...
- in the <span id="date">provide current year: {new Date().getFullYear()}
...
- check if latest git is installed:

```sh
git --version
```

- if not, install latest git
  - https://git-scm.com/download/win
  <!-- - if remove existing git repo
  - Mac : rm -rf .git
  - Windows : rmdir -Force -Recurse .git
  - Windows : rd /s /q .git
    Windows commands were shared by students and I have not personally tested them. -->
- setup new repo on github
  - git init
